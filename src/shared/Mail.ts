    ...
    if (type === "user") {
      return {
        ...
        html: `
          ...
          <p>In case you find any discrepancies in the data entered, you may please mail the correct details to <a href="mailto:sidharth.arya@sparecare.in">sidharth.arya@sparecare.in</a>.</p>
          <br/>
